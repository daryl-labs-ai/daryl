...
<img src="https://img.shields.io/badge/tests-589%20passing-brightgreen">
...
```bash
pip install -e .[dev]
python -m pytest tests/ -v   # 589 tests, 0 failures
```
...
tests/                 # 589 tests — core, session, rr, ans, A→E, security, integration
