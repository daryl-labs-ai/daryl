...
<img src="https://img.shields.io/badge/tests-698%20passing-brightgreen">
...
```bash
pip install -e .[dev]
python -m pytest tests/ -v   # 698 tests, 0 failures
```
...
tests/                 # 698 tests — core, session, rr, ans, A→E, security, integration
