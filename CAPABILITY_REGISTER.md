...
──────────────────────────────────────────────
  ...
  PROOF VELOCITY
  Last proof       2026-07-01  Governed standing v1 — the first governed reading (ADR-PRL-0011)
  Previous proof   2026-07-01  Governance layer v0 — a governance posture derives read-only above latest-wins
  Recent cadence   2026-06-27 → 2026-07-01 : 5 assets + 8 frontiers proven (step (c) → first governed reading)
