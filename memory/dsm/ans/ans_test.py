...
def test_log_loading():
    ...
    usage_log = os.path.join(dsm_v2_dir, "skills", "logs", "skills_usage.jsonl")
    success_log = os.path.join(dsm_v2_dir, "skills", "logs", "skills_success.jsonl")
...
def test_recommend_cli_commands():
    ...
    result = os.popen("python3 -m dsm_v2.ans.cli recommend", shell=True)
