...
class ANSEngine:
    ...
    def __init__(
        ...
        """Initialize ANS engine with log file paths.
        ...
        """
        # Set default paths relative to dsm_v2/skills/
    ...
    def recommend_next_skills(self, skill_id: str = None) -> List[SkillRecommendation]:
        ...
        # If no skill_id, return global best skills
        if skill_id is None:
            return self.rank_top_skills(limit=5)
        ...
        if report.recommendations:
            ...
            for i, rec in enumerate(report.recommendations, 1):
                ...
                print(
                    ...
                    f"priority: {rec.priority}) - {rec.explanation}"
                )
            print()
