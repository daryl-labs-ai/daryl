...
def run_all_tests():
    ...
    test_dir = Path(__file__).parent / "dsm_v2"
    ...
    print("  python3 dsm_v2/trace_replay.py --list-sessions")
    print("  python3 dsm_v2/trace_replay.py --session <session_id>")
    print("=" * 70 + "\n")
    ...
    report_path = Path(__file__).parent / "dsm_v2_stability_report.json"
