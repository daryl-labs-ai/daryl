...
CRITICAL_FILES = [
    ...
    "dsm_v2/core/security.py",  # Self-protection
    # CLI
    "dsm_v2/cli.py",
    ...
    def _check_git_status(self) -> Dict[str, str]:
        ...
        try:
            ...
            for line in result.stdout.strip().split('\n'):
                ...
                # CRITICAL_FILES contient "dsm_v2/core/storage.py" donc on doit matcher ça
...
def cmd_self_check(args):
    """Commande: python -m dsm_v2 security self-check (JSON output)"""
    security = SecurityLayer()
