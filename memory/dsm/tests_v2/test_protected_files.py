...
from dsm_v2.core.security import SecurityLayer, PROTECTED_WRITE_FILES
...
def test_protected_files_write_guard():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        allowed, message = security.check_protected_write("dsm_v2/core/security.py")
        ...
        if audit_file.exists():
            with open(audit_file, 'r') as f:
                ...
                assert "dsm_v2/core/security.py" in content, "❌ Cas D FAILED: Audit should contain path"
        ...
        os.environ["DSM_SECURITY_REWRITE_OK"] = "1"
        security.check_protected_write("dsm_v2/cli.py")
        del os.environ["DSM_SECURITY_REWRITE_OK"]
