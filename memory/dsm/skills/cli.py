...
# Direct imports from individual DSM-SKILLS modules
from dsm_v2.skills.models import Skill
from dsm_v2.skills.registry import SkillRegistry
from dsm_v2.skills.router import SkillRouter
from dsm_v2.skills.ingestor import SkillIngestor
from dsm_v2.skills.skill_usage_logger import SkillUsageLogger
from dsm_v2.skills.skill_success_logger import SkillSuccessLogger
from dsm_v2.skills.success_analyzer import SkillSuccessAnalyzer
from dsm_v2.skills.skill_graph import SkillGraph
...
def cmd_list(args):
    ...
    libraries_dir = os.path.join(dsm_v2_dir, "skills", "libraries")
    if os.path.isdir(libraries_dir):
        for library_name in os.listdir(libraries_dir):
            ...
            if os.path.isdir(library_path):
                count = ingestor.ingest_from_directory(library_path)
                print(f"Ingested {count} skills from {library_name}", file=sys.stderr)
